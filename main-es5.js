...
var WeatherComponent = /** @class */ (function () {
    ...
    WeatherComponent.prototype.weatherResult = function () {
        var _this = this;
        ...
        this.weather.getWeather(this.city, this.unit)
            ...
            _this.temperature = result.main.temp;
            _this.country = result.sys.country;
            _this.icon = result.weather[0].icon;
            _this.cityName = result.name;
...
var WeatherService = /** @class */ (function () {
    ...
    WeatherService.prototype.getWeather = function (city, u) {
        console.log(city);
